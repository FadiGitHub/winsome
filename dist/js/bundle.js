...
var _functions_module = __webpack_require__(2);

var _functions_module2 = _interopRequireDefault(_functions_module);
...
$(document).ready(function () {
  ...
  $('form').on('submit', function (event) {
    ...
    $('#list_item_input').val('');
    (0, _functions_module2.default)(item_obj, listItems);
  });
});
